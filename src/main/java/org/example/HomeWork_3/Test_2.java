...
public class Test_2 {
    ...
    public static void main(String[] args){
        ...
        WebElement webElement4 = driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[2]/div[3]/div/div[2]/div[1]/div[4]/button[2]"));

        webElement4.click();

        WebElement webElement5 = driver.findElement(By.xpath(".//*[@class='cart-link__lbl']"));
